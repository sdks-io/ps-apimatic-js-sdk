...
```ts
import { PurchaseSuccess3 } from 'ps-apimatic-sdk';

const purchaseSuccess3: PurchaseSuccess3 = {
  ...
  skipCapture: false,
  referenceGenerated: 'PS10252',
  issued: '2024-06-27',
  due: 1719466796,
  refundUpto: 1735015199,
  ccDescriptor: '',
  fraudScore: 'NA',
  trustScore: 'NA',
  payInDetails: {
