...
# Payout Session with Crypto Conversion

*This model accepts additional fields of type unknown.*

## Structure

`PayoutSessionWithCryptoConversion`
...
```ts
import { PayoutSessionWithCryptoConversion } from 'ps-apimatic-sdk';

const payoutSessionWithCryptoConversion: PayoutSessionWithCryptoConversion = {
